...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'AI-Powered Loan Utilization Tracking System'**
  ...
  /// No description provided for @sanctionedLoan.
  ///
  /// In en, this message translates to:
  /// **'Sanctioned Loan Disbursement'**
  String get sanctionedLoan;

  /// No description provided for @submitEvidence.
  ///
  /// In en, this message translates to:
  /// **'Submit Loan Utilization Evidence'**
